...
export const options = {
  stages: [
    ...
    { duration: "15s", target: 50 },  // Pico: sobe para 500 usuários simultâneos
    { duration: "20s", target: 50 },  // Sustenta 500 usuários por 1 minuto
    { duration: "25s", target: 0 }     // Ramp-down rápido para 0
  ]
}
